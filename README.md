...
### 2. 1부터 45 사이의 난수 6개 생성 기능
- <code>Random.pickUniqueNumbersInRange(1, 45, 6)</code>로 난수 6개를 생성한다.
- 생성한 6개의 수를 배열에 담아 반환한다.

### 3. 발행한 로또 번호 출력 기능
- <code>Console.print()</code>를 통해 출력한다.
- 사용자가 구매한 로또 개수를 출력한다.
- 사용자의 입력한 금액에 따라 로또 개수만큼 발행한 로또들의 번호를 출력한다.
- 출력 후 각 로또들을 배열로 담아 반환한다.
- ex)
  ```
  8개를 구매했습니다.
  [8, 21, 23, 41, 42, 43] 
...
- 반환받은 배열은 Lotto 클래스에 등록되어 객체를 생성한다.
